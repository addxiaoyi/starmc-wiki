...
const toPinyinInitials = (text: string): string => {
  const pyMap: Record<string, string> = {
    ...
    '答':'d','案':'a','技':'j','巧':'q','攻':'g','略':'l','设':'s',
    '配':'p','安':'a','装':'z','启':'q','客':'k','户':'h','端':'d',
    '器':'q','版':'b','本':'b','更':'g','告':'g','闻':'w','活':'h',
    '奖':'j','励':'l','物':'w','品':'p','材':'c','料':'l','合':'h',
    '成':'c','台':'t','徽':'h','章':'z','矩':'j','阵':'z','核':'h',
    '心':'x','党':'d','派':'p','战':'z','队':'dui','贸':'m','易':'y',
    '币':'b','金':'j','银':'yin','铜':'tong','铁':'t','木':'m','钻':'z',
    '主':'z','权':'q','块':'k','边':'b','界':'j','态':'t','环':'h',
    '境':'j','资':'z','源':'y','矿':'k','洞':'d','森':'s','林':'l',
    '平':'p','原':'y','山':'s','脉':'m','海':'h','岸':'an','岛':'dao','村':'c',
  };
